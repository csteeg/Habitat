namespace Sitecore.Foundation.Dictionary
{
    ...
    public struct Templates
    {
        ...
        public struct DictionaryRichTextEntry
        {
            public static ID ID => new ID("{8AD02C1E-E04A-44E1-ACD7-BF4729A98F03}");
            public struct Fields
            {
                public static ID Phrase => new ID("{53E63759-9690-4B7E-87C4-C6BDD142AD16}");
            }
        }
